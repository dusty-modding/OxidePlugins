var RanksAndTitles = {
	...
	setRankTitle: function(playerID, player) {
		try {
			...
			for (i; i < j; i++) {
				if (karmaOn && TitlesData.PlayerData[playerID].Title != this.Config.Ranks[i].title && karma === this.Config.Ranks[i].karma) {
					print("Found correct logic")
					...
					print(TitlesData.PlayerData[playerID].Title);
				} else if (!karmaOn && kills === this.Config.Ranks[i].killsNeeded) {
					print("found in correct logic")
					TitlesData.PlayerData[playerID].Title = this.Config.Ranks[i].title;
					TitlesData.PlayerData[playerID].Rank = this.Config.Ranks[i].rank;
				}
			}
