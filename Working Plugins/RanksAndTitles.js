  ...
  debug: function(player, cmd, args) {
    try {
      ...
      if (!this.Config.Settings.deBugOff || authLvl >= 2) {
        ...
        print("Admins turned off: " + this.Config.Settings.noAdmin);
        print("Number of Ranks: " + this.Config.main.length);
        print("Number of Titles: " + this.Config.prefixTitles.length);
